...
class Menu(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.btn_os.grid(row=0, column=0, pady=10, padx=0)
        ...
        self.btn_clientes.grid(row=1, column=0, pady=10, )
        ...
        self.btn_estoque.grid(row=2, column=0, pady=10, )
        ...
        self.btn_financeiro.grid(row=3, column=0, pady=10, )
